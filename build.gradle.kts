...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name = "[Deprecated] Problem4J Core"
                description =
                    "[Deprecated] Core library implementing Problem model according to RFC7807. Migrated to io.github.problem4j:problem4j-core namespace."
